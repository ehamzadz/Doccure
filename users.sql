...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 23, 2022 at 09:52 PM
...
('admin', 'Ammari.', 'Liamine', '1975-05-12', '+AB', 'admin@avismed.net', '0661751150', 'Fibour', 'Bordj Bou Arreridj', 'Bordj Bou Arreridj', 34000, 'Algeria', '310406027949527927LIAMINE-AMMARI.png', '$2y$10$iqOScLiZxGadF9pK2qNh4uFL8smn1oGywToFZXXk4tShzGAJcr4n6', 'D', 'online', 15000, NULL, NULL, NULL, 1);
...
--
ALTER TABLE `registrations`
  MODIFY `id_registrations` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
